#!/usr/bin/env Rscript
# render_with_literature.R
# Script to render the Epic In-Basket Analysis report with literature review
...
qmd_file <- "epic_inbasket_analysis_with_literature.qmd"
...
# Render the document
cat("Rendering Epic In-Basket Analysis report with literature review...\n")
...
result <- tryCatch({
  ...
  cat("Output: epic_inbasket_analysis_with_literature.html\n")
...
html_output <- "epic_inbasket_analysis_with_literature.html"
