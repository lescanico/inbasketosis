#!/usr/bin/env Rscript
# render_comprehensive.R
# Script to render the comprehensive Epic In-Basket Analysis report with integrated literature review
...
qmd_file <- "epic_inbasket_analysis_comprehensive.qmd"
...
# Render the document
cat("Rendering Comprehensive Epic In-Basket Analysis report with integrated literature review...\n")
...
result <- tryCatch({
  ...
  cat("Output: epic_inbasket_analysis_comprehensive.html\n")
...
html_output <- "epic_inbasket_analysis_comprehensive.html"
